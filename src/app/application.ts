...
import { getFullSeverPath } from '../utils/common.js';
...
export default class Application {
  ...
  public async init() {
    ...
    this.initMiddleware();
    this.initRoutes();
    this.initExceprionFilters();
    this.expressApp.listen(this.config.get('PORT'));
    this.logger.info(`Server started on ${getFullSeverPath(this.config.get('HOST'),
