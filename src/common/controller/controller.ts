...
import { getFullSeverPath, transformObject } from '../../utils/common.js';
...
export abstract class Controller implements ControllerInterface {
  ...
  protected addStaticPath(data: UnknownObject): void {
    const fullServerPath = getFullSeverPath(this.configService.get('HOST'), this.configService.get('PORT'));
    transformObject(
